...
GLuint LoadShaders(const char * vertex_file_path,const char * fragment_file_path)
{
    ...
    char version[20] = { 0 };
    //std::snprintf(version, sizeof(version) / sizeof(*version), "#version %i%i0\n", GLVersion.major, GLVersion.minor);
	std::string VertexShaderCode;
    //VertexShaderCode += "#version 450 core \n";
    //VertexShaderCode += Shadinclude::load(vertex_file_path) + "\n";
    ...
    //VertexShaderCode += Shadinclude::load(vert_filenanme);
	// Read the Fragment Shader code from the file
	std::string FragmentShaderCode;
    //FragmentShaderCode += "#version 450 core";
    //FragmentShaderCode += Shadinclude::load(fragment_file_path);
